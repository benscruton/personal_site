...
const bookshelf: Project = {
  ...
  pitch: [
    ...
    "The core concept is the the user's Shelves: users are assigned four shelves upon joining, but they can add, edit, and remove custom shelves as well.  Users can find books by searching for them in the database, or by adding their own.  Then, they can add those books to any of their shelves, or add them to their friends' \"Recommended\" shelf."
  ],
  spotlightMedia: {
