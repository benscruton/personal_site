...
import responsiveAddr from "./responsive_combined.ogg";
import newUserShelvesAddr from "./new_user_shelves.png";
import customizeShelvesAddr from "./customize_shelves.ogg";
import addBookToShelfAddr from "./add_book_to_shelf.ogg";
...
import friendRequestsAddr from "./friend_requests.ogg";
